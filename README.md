![alt text](image.png)![alt text](image.png)![alt text](image.png)![alt text](image.png)![alt text](image.png)# Платформа Опросов - Руководство пользователя
...
Платформа Опросов - это веб-сервис для создания и управления формами, диагнозами и рекомендациями. Система позволяет:
